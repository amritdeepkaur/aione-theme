...
register_block_pattern(
	...
	array(
		...
		<div class="wp-block-aione-blocks-aione-button align-center"><div class="aione-button-container"><a href="#" target="_blank" class="aione-button fullwidth square  bg-grey bg-lighten-2  hover-bg-grey hover-bg-lighten-1 blue-grey darken-4 border-black" rel="noopener noreferrer">Why we are different ?</a></div></div>
...
register_block_pattern(
	...
	array(
		...
		<div class="wp-block-aione-blocks-aione-button"><div class="aione-button-container"><a href="#" target="_blank" class="aione-button small rounded outline  hover-white " rel="noopener noreferrer">Download</a></div></div>
		<!-- /wp:aione-blocks/aione-button --></div>
...
register_block_pattern(
	...
	array(
		...
		<div class="wp-block-aione-blocks-aione-button green border-red"><div class="aione-button-container"><a href="#" target="_blank" class="aione-button small rounded outline  hover-bg-orange hover-bg-darken-3 orange darken-3 hover-white border-orange border-darken-3" rel="noopener noreferrer">Download</a></div></div>
		<!-- /wp:aione-blocks/aione-button --></div>
		<!-- /wp:aione-blocks/aione-wrapper --></div></section>
		<!-- /wp:aione-blocks/aione-section -->
		',
